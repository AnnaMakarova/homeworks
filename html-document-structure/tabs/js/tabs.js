...
const tabsContent = tabs.getElementsByClassName('tabs-content')[0];
const tabsContentItems = tabsContent.children;
const tabsNav = tabs.getElementsByClassName('tabs-nav')[0];
const navItem = tabsNav.firstElementChild;
